...
ggpairs(data_trial %>% dplyr::select(
	'x_pos', 'y_pos', 'glasses_binary', 'chin', 'precision', 'offset'),
    progress = F) 
...
### Random slopes
 ...
 - (Unfortunately), the RS-model is better, so the effect of chin-rest largely varies.
...
summary(lmer4_rs)
# ranef(lmer4_rs)
anova(lmer3_experimental, lmer4_rs)
```
