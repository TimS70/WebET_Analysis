...
def add_k_means_clusters(data, transition_columns, path_tables):
...
def add_transition_clusters(data_trial, path_tables,
    ...
    data_trial = add_k_means_clusters(data=data_trial,
                                      transition_columns=transition_columns,
                                      path_tables=path_tables)

    # data_trial = hierarchical_clusters(
    #     data=data_trial,
    #     transition_columns=transition_columns,
    #     max_clusters=10)
