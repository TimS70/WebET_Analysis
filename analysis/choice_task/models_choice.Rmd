...
temp = data_trial %>% 
    merge_mean_by_subject(data_subject, 'birthyear') %>%
...
ggsave(file.path(path_results, 'correlations', 'participant.png'), 
	   width=5.5, height=5)
...
ggpairs(
    ...
    progress = F) +
	theme_bw()
ggsave(file.path(path_results, 'correlations', 'trial.png'),
	   width=5.5, height=5)
```
