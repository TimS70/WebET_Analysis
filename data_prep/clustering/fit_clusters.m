function [largest_clusters] = fit_clusters(...
    ...
    if plot_results
        ...
        mkdir(fullfile(...
            ...
            'results', 'plots', 'clustering', run_name));
        scatter_plot(data(:, 4), data(:, 5), ...
            fullfile(...
                'C:\Users\User\GitHub\WebET_Analysis', ...
                'results', 'plots', 'clustering', run_name, 'uncorrected.png'));
    end
