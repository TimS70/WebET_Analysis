from data_prep.load.eye_tracking import create_et_data_1, create_et_data_2
...
def create_datasets_from_cognition(path_origin, path_target):
    ...
    data_et = create_et_data_2(data_combined, n_bins=10)
    print(data_et)
    data_et = create_et_data_1(data_combined)
    print(data_et)
    exit()
