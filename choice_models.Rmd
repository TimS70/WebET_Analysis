...
merge_mean_by_subject = function(data, data_source, varName) {
    ...
    data = merge(
        data, 
        grouped %>% dplyr::select(run_id, varName), 
        by='run_id')
    return(data)
}
...
# Simple Slope 1
data_trial_choice$PI_sd1 = data_trial_choice$payneIndex_cmc + sd_PI_cmc
m3_sd1 = glmer(
    choseLL ~ 
...
# Simple Slope -1
data_trial_choice$PI_sd0 = data_trial_choice$payneIndex_cmc - sd_PI_cmc
m3_sd0 = glmer(
    choseLL ~ 
