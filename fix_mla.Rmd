...
# Temp: Only using the most powerful predictors
None of the variables add much
```{r}
temp_m_ri_1 = lme(
    offset ~ y_pos, 
    data=data_trial_fix,
...
temp_m_ri_3 = lme(
    offset ~ y_pos + glasses_binary + chin, 
    data=data_trial_fix,
    method='ML', 
    na.action='na.omit', 
    random = ~1 | run_id
...
summary(temp_m_ri_3)
anova(m_ri_0, temp_m_ri_1, temp_m_ri_3)
```
