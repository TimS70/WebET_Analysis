function [largest_clusters] = fit_clusters(...
    ...
    if plot_results
        ...
        mkdir(fullfile('..', 'results', 'plots', 'clustering', run_name));
        scatter_plot(data(:, 4), data(:, 5), ...
            fullfile('..', 'results', 'plots', 'clustering', run_name, 'uncorrected.png'));
    end
    ...
    if plot_results
        scatter_plot_clusters(data(:, 4), data(:, 5), data(:, 7), ...
            grandmean, ...
            fullfile('..', 'results', 'plots', 'clustering', run_name, 'clusters.png'));
    end
    ...
    if plot_results
        ...
        scatter_plot_clusters(...
            ...
            grandmean, ...
            fullfile('..', 'results', 'plots', 'clustering', run_name, 'corner_clusters.png'));
    end
end