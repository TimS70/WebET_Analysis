function [adjET] = move_clusters(data, clusters, aoi_width, aoi_height)
    ...
    for i=1:4 %for each AOI          
       ...
       if clusters(i, 1) > 0
           ...
           % col 5: t task
           % col 6: aoi
           adjET(ind_withinCluster, :) = ...
               [...
                   data(ind_withinCluster, 1:3), ...
                   data(ind_withinCluster, 4) + x_bias, ...
                   data(ind_withinCluster, 5) + y_bias, ...
                   data(ind_withinCluster, 6), ...
